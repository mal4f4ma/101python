...
### Python en terminal
Despues de haber agregado correctamente al path la ruta del ejecutable de python podremos abrir en la terminal un interprete, pude ser en CMM o PowerShell, para esto en la terminal escribimos simplemente python o el nombre de su ejecutable
```
